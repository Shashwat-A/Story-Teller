              ...
              <View style={styles.dataContainer}>
                ...
                <View style={styles.iconContainer}>
                  <TouchableOpacity onPress={()=> {
                    this.initateTTS(this.props.route.params.story.title, this.props.route.params.story.author, this.props.route.params.story.story, this.props.route.params.story.moral)
                  }}>
                    <Ionicons
